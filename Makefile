...
.PHONY: $(TARGET).nds arm7/$(TARGET).elf arm9/$(TARGET).elf clean

all: $(TARGET).nds

$(TARGET).nds:	$(TARGET).arm7 $(TARGET).arm9
	ndstool	-c $(TARGET).nds -7 $(TARGET).arm7.elf -9 $(TARGET).arm9.elf \
			-b $(CURDIR)/icon.bmp "CPU Speed Check;Rocket Robz" \
			-g CPUC 00 "CPUCHECK" -z 80040000 -u 00030004
